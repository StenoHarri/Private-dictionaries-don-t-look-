...
SIMPLE_STARTERS = {
    ...
    "SKPWHO": ("and who", None),
    "SWHR": ("where", None),
    "SWHO": ("who", None), #would be nice if I could have "who knows"
    "TKWHRO": ("how", None),
    #"STKWHRO": ("so how", None),
    "STKWH": ("why", None),
    "SPWH": ("but", None),
    #"SKPHRA": ("because", None),
    "STPR": ("for", None), # would be nice if I could have "for being" 

    # Remove the entry below if you don't want "and" phrases.
    # "SKP": ("and", None),
    "SKPH": ("and", None), #would be nice if I could have "and runs"
    "SKPHA": ("and", None),
}
...
ENDERS = {
    ...
    # PLG - To guess (that)
    "RPBLG": ("present", {None: " guess", "3ps": " guesses", "present-participle": " guessing", "past-participle": " guessed"}),
    "RPBLGT": ("present", {None: " guess that", "3ps": " guesses that", "present-participle": " guessing that", "past-participle": " guessed that"}),
    "RPBLGD": ("past", {None: " guessed", "root": " guess", "present-participle": " guessing", "past-participle": " guessed"}),
    "RPBLGTD": ("past", {None: " guessed that", "root": " guess that", "present-participle": " guessing that", "past-participle": " guessed that"}),
    ...
    # RPBLS - To turn (to)
    "RPBLS": ("present", {None: " turn", "3ps": " turns", "present-participle": " turning", "past-participle": " turned"}),
    "RPBLTS": ("present", {None: " turn to", "3ps": " turns to", "present-participle": " turning to", "past-participle": " turned to"}),
    "RPBLSZ": ("past", {None: " turned", "root": " turn", "present-participle": " turning", "past-participle": " turned"}),
    "RPBLTSDZ": ("past", {None: " turned to", "root": "turn to", "present-participle": " turning to", "past-participle": " turned to"}),
    ...
    # RLZ - To return
    "RLZ": ("present", {None: " return", "3ps": " returns", "present-participle": " returning", "past-participle": " returned"}),
    "RLDZ": ("past", {None: " returned", "root": " return", "present-participle": " returning", "past-participle": " returned"}),
    ...
    # RL - To remind
    "RPLG": ("present", {None: " remind", "3ps": " reminds", "present-participle": " reminding", "past-participle": " reminded"}),
    "RPLGD": ("past", {None: " reminded", "root": " remind", "present-participle": " reminding", "past-participle": " reminded"}),
    ...
    # RLS - To realise (that)
    "RLGS": ("present", {None: " realise", "3ps": " realises", "present-participle": " realizing", "past-participle": " realised"}),
    "RLGTS": ("present", {None: " realise that", "3ps": " realises that", "present-participle": " realizing that", "past-participle": " realised that"}),
    "RLGSZ": ("past", {None: " realised", "root": " realise", "present-participle": " realizing", "past-participle": " realised"}),
    "RLGTSDZ": ("past", {None: " realised that", "root": " realise that", "present-participle": " realizing that", "past-participle": " realised that"}),
    ...
    # RPLS: To stay
    "BLGS": ("present", {None: " stay", "3ps": " stays", "present-participle": " staying", "past-participle": " stayed"}),
    "BLGSZ": ("past", {None: " stayed", "root": " stay", "present-participle": " staying", "past-participle": " stayed"}),
    ...
    # RPBZ - To meet
    "RPBZ": ("present", {None: " meet", "3ps": " meets", "present-participle": " meeting", "past-participle": " met"}),
    "RPBDZ": ("past", {None: " met", "root": " meet", "present-participle": " meeting", "past-participle": " met"}),
